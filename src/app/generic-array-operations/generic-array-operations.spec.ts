/**
 * @file generic-array-operations.spec.ts
 * @description 
 * @author Neha Mishra
 * @copyright copyright by winjit
 */

import { GenericArrayOperations } from "./generic-array-operations";
describe('GenericArrayOperations', () => {
    describe('filter', () => {
      it('should filter elements based on the predicate function', () => {
        const numbers = [1, 2, 3, 4, 5];
        const isEven = (n: number) => n % 2 === 0;
        const result = GenericArrayOperations.filter(numbers, isEven);
    ...
    describe('map', () => {
      it('should transform each element using the transformation function', () => {
        ...
        const result = GenericArrayOperations.map(numbers, square);
      ...
      it('should allow input and output types to differ', () => {
        ...
        const result = GenericArrayOperations.map(numbers, toString);
    ...
    describe('reduce', () => {
      it('should accumulate a single result using the reducer function', () => {
        ...
        const result = GenericArrayOperations.reduce(numbers, sum, 0);
      ...
      it('should work with different accumulator and value types', () => {
        ...
        const result = GenericArrayOperations.reduce(strings, concat, '');
    ...
    describe('chunk', () => {
      it('should split an array into chunks of specified size', () => {
        const numbers = [1, 2, 3, 4, 5];
        const result = GenericArrayOperations.chunk(numbers, 2);
        expect(result).toEqual([[1, 2], [3, 4], [5]]);
      });
  
      it('should return the original array if the size is larger than the array length', () => {
        const numbers = [1, 2, 3];
        const result = GenericArrayOperations.chunk(numbers, 5);
    ...
    describe('flatten', () => {
      it('should flatten a nested array into a single-level array', () => {
        ...
        const result = GenericArrayOperations.flatten(nestedArray);
        expect(result).toEqual([1, 2, 3, 4, 5]);
      });
    ...
    describe('unique', () => {
      it('should remove duplicate elements from an array', () => {
        ...
        const result = GenericArrayOperations.unique(numbers);
        expect(result).toEqual([1, 2, 3, 4, 5]);
      });
    ...
    describe('intersection', () => {
      it('should return an array with common elements from both arrays', () => {
        ...
        const result = GenericArrayOperations.intersection(array1, array2);
    ...
    describe('union', () => {
      it('should return an array with all unique elements from both arrays', () => {
        const array1 = [1, 2, 3];
        const array2 = [3, 4, 5];
        const result = GenericArrayOperations.union(array1, array2);
        expect(result).toEqual([1, 2, 3, 4, 5]);
      });
